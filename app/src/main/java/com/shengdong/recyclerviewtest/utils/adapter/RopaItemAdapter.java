...
public class RopaItemAdapter extends RecyclerView.Adapter<RopaItemAdapter.ShoeItemViewHolder> {

    private List<ShoeItem> shoeItemList;
    private ShoeClickedListeners shoeClickedListeners;
    public RopaItemAdapter(ShoeClickedListeners shoeClickedListeners){
    ...
    public ShoeItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.each_ropa, parent , false);
